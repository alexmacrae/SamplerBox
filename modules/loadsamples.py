...
class LoadingSamples:
    ...
    def pause_if_playingsounds_or_midi(self):
        ...
        if self.preset_current_is_loaded and self.preset_current_loading != gv.samples_indices[gv.preset]:
            if gv.playingsounds or self.midi_detected:
                ...
                for i in xrange(999999):
                    ...
                    sys.stdout.write('\r[!] LOADING PAUSED: sounds or MIDI are active')
                    sys.stdout.flush()
                    time.sleep(self.pause_sleep)
            else:
                # print '++ Keep loading ++'
                        ...
                        try:
                            ...
                            for fname in os.listdir(dirname): # iterate over samples in the dir
                                ...
                                if m:
                                    ...
                                    if gv.samples[self.preset_current_loading].has_key(
            ...
            # If no definition.txt file found in folder, look for numbered files (eg 64.wav, 65.wav etc)
                ...
                for midinote in range(0, 127):
                    ...
                    if os.path.isfile(file_):
                        ...
                        gv.samples[self.preset_current_loading][midinote, 127, 1, channel] = sound.Sound(file_,
                                                                                                         midinote, 127,
                                                                                                         channel,
                                                                                                         gv.BOXRELEASE)
                    ...
                    for midinote in xrange(128):
                        ...
                        for velocity in xrange(128):
                            if (
                                ...
                                last_velocity = gv.samples[self.preset_current_loading][
                                    midinote, velocity, voice, gv.MIDI_CHANNEL]
                            else:
                                if last_velocity:
                                    gv.samples[self.preset_current_loading][
                                        midinote, velocity, voice, gv.MIDI_CHANNEL] = last_velocity
