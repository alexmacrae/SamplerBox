configdefaults = {
    ...
    'USE_ALSA_MIXER': {'type': 'boolean', 'default': False, 'section': 'SAMPLERBOX CONFIG'},
    'SAMPLES_DIR': {'type': 'string', 'default': './media', 'section': 'SAMPLERBOX CONFIG'},
    ...
    'MIXER_CARD_ID': {'type': 'int', 'default': -1, 'section': 'SAMPLERBOX CONFIG'},
    'MIXER_CONTROL': {'type': 'options', 'options': [], 'default': 'Speaker', 'section': 'SAMPLERBOX CONFIG'},
    'SYSTEM_MODE': {'type': 'options', 'options': ['1', '2'], 'default': 1, 'section': 'SAMPLERBOX CONFIG'},
    'RAM_LIMIT_PERCENTAGE': {'type': 'range', 'min': 1, 'max': 95, 'default': 40, 'section': 'SAMPLERBOX CONFIG'},
    ...
    'BUTTON_LEFT_MIDI': {'type': 'midi', 'default': 'undefined', 'section': 'MIDI BUTTON NAVIGATION FOR SYSTEM MODE 1'},
    'BUTTON_RIGHT_MIDI': {'type': 'midi', 'default': 'undefined', 'section': 'MIDI BUTTON NAVIGATION FOR SYSTEM MODE 1'},
    'BUTTON_ENTER_MIDI': {'type': 'midi', 'default': 'undefined', 'section': 'MIDI BUTTON NAVIGATION FOR SYSTEM MODE 1'},
    'BUTTON_CANCEL_MIDI': {'type': 'midi', 'default': 'undefined', 'section': 'MIDI BUTTON NAVIGATION FOR SYSTEM MODE 1'},

    'BUTTON_UP_MIDI': {'type': 'midi', 'default': 'undefined', 'section': 'MIDI BUTTON NAVIGATION FOR SYSTEM MODE 2'},
    'BUTTON_DOWN_MIDI': {'type': 'midi', 'default': 'undefined', 'section': 'MIDI BUTTON NAVIGATION FOR SYSTEM MODE 2'},
    'BUTTON_FUNC_MIDI': {'type': 'midi', 'default': 'undefined', 'section': 'MIDI BUTTON NAVIGATION FOR SYSTEM MODE 2'},
